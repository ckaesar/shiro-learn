package com.kaesar.shiro.learn.chapter5.hash;
...
public class CodecAndCryptoTest {
	...
	private final static Logger LOGGER = LoggerFactory.getLogger(CodecAndCryptoTest.class);
	...
	public void testRandom() {
		...
		LOGGER.debug(randomNumberGenerator.nextBytes().toHex());
	}
